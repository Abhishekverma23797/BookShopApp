...
<div class="container-fluid p-3">
	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<a href="Login.jsp" class="btn btn-success "><i class="fas fa-sign-in-alt"></i>  Login</a> <a
				href="Register.jsp" class="btn btn-primary"><i class="fas fa-user-plus"></i>  Register</a>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<form class="from-inline my-2 my-lg-0">
				<button class="btn btn-danger my-2 my-sm-0 ml-1" type="submit">
